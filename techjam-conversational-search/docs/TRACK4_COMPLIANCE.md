...
The deterministic v2.14.0 run on all 200 released development sessions produces:

- Hit Rate@10: `1.0` (200/200)
- MRR: `0.984306`
- MTTC: `2.74`
- Efficiency: `0.826`
- Technical Score: `0.960492`
...
harness from catalog targets the public set never uses: Technical Score `0.936336`
(v2.13.0 `0.933532`, v2.12.1 `0.910664` on the identical held-out set).
