...
- `docs/v2.11.0_release_notes.md` - current release results, validation steps, and the
...
Current deterministic implementation: **v2.11.0**. On the released 200-session public
set it reaches Hit Rate@10 `1.0` (200/200), MRR `0.583518`, MTTC `2.70`, and
Technical Score `0.841055`, with zero LLM tokens. These are development-set results;
