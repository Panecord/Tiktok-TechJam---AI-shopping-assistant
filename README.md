...
- `docs/v2.12.1_release_notes.md` - current release results, validation steps, and the
...
Current deterministic implementation: **v2.12.1**. On the released 200-session public
set it reaches Hit Rate@10 `1.0` (200/200), MRR `0.948458`, MTTC `3.315`, and
Technical Score `0.938237`, with zero LLM tokens. These are development-set results;
